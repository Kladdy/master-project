...
# New in v7: We now sample ENDF/B-VIII.0 instead of JEFF-3.3
...
PROCESSES = 50 # number of worker processes
MT = args.MT # MT number to sample, None if all MTs should be sampled (2=elastic scattering, 102=neutron capture)
endf_dir = "/home/fne23_stjarnholm/nuclear_data/ENDF-B-VIII.0/neutrons" 
output_dir = "/home/fne23_stjarnholm/nuclear_data/sandy_samples_v7"
...
file_name = f"{prefix}{file_atomic:0>3}_{atomic_sym}_{file_mass:0>3}{suffix}"
