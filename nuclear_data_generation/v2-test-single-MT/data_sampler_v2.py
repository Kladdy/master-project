# TEST: Try to specify --mt 2 to only sample the elastic scattering
...
output_dir = "/home/fne23_stjarnholm/nuclear_data/sandy_samples_v2_TEST_SINGLE_MT_TEST-MT002"
...
tape20_command = f"sandy tape20 --mt 2 --samples {SAMPLES} --processes {PROCESSES}"
print(f"Running command: {tape20_command}")
os.system(tape20_command)
# exit()
# %%
# Step 3: sandy tape30 --cov tape45 --seed33 1 --samples 2
tape30_command = f"sandy tape30 --mt 2 --cov tape45 --seed33 1 --samples {SAMPLES} --processes {PROCESSES}"
