# - Date: 14/05/2023
# - Based on: Model v3
# - Description: based on R15, but now only do thermal and no sampling and do the following:
# Nevertheless, can you please just check in one of your calcs, 
# that the spectrum in the moderator with and without S(a,b) makes any difference 
# (also whether it makes any difference for the k-eff).
...
for REACTOR_MODEL in [model_tools.THERMAL_REACTOR]:
    for use_thermal_scattering in [True, False]:
        ...
        # Materials
        material_fuel, material_moderator, material_cladding = model_tools.get_materials(FUEL_TEMP, CLADDING_TEMP, MODERATOR_TEMP, use_thermal_scattering=use_thermal_scattering)
        ...
        for i in range(N_ITERATIONS):
            ...
            run_settings = {
                ...
                "seed": settings.seed,
                "use_thermal_scattering": use_thermal_scattering
            }
