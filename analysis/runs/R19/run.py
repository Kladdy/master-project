# - Date: 17/04/2023
# - Based on: Model v3
# - Description: Get intgral values of reaction rates for the different reactions
#   but look actually in the whole reactor, inclduing plenum (same as R16 but acutally correct this time...)
...
for REACTOR_MODEL in [model_tools.THERMAL_REACTOR, model_tools.SEMIEPITHERMAL_REACTOR, model_tools.EPITHERMAL_REACTOR]:
    ...
    # energybins = np.logspace(np.log(1e-5), np.log(2e7), 2001) # 2000 bins between 1e-5 eV and 2e7 eV
    ...
    tally1.scores = ['flux','fission', 'absorption', 'total', "2", "4", "16", "22", "28", "102", "103", "104", "105", "107"]
    # END Tally 1
    ...
    tally2.scores = ['flux','fission', 'absorption', 'total', "2", "4", "16", "22", "28", "102", "103", "104", "105", "107"]
    # END Tally 2
    ...
    # tally3.filters = [cell_filter3]
    tally3.scores = ['flux','fission', 'absorption', 'total', "2", "4", "16", "22", "28", "102", "103", "104", "105", "107"]
    # END Tally 3
