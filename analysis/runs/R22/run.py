# - Date: 17/04/2023
# - Based on: Model v3
# - Description: SAME AS R20 but no thermal scattering law, but 900 K for the moderator
#   Does not do any sampling

use_thermal_scattering = False
...
for REACTOR_MODEL in [model_tools.THERMAL_REACTOR, model_tools.EPITHERMAL_REACTOR, model_tools.SEMIEPITHERMAL_REACTOR]:
    ...
    # Materials
    material_fuel, material_moderator, material_cladding = model_tools.get_materials(FUEL_TEMP, CLADDING_TEMP, MODERATOR_TEMP, use_thermal_scattering)
    ...
    tally3.filters = [energy_filter]
    tally3.scores = ['flux','fission']
    # END Tally 3

    # Tally 4: heating-local and heating
    tally4 = openmc.Tally(4)
    tally4.scores = ['heating-local','heating']
    # END Tally 4
