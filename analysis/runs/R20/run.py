# - Date: 17/04/2023
# - Based on: Model v3
# - Description: SAME AS R18 but Run a neutron-only calculation and estimate the total heating using the heating-local score (this requires that your nuclear data has local heating data available, such as in the official data library at https://openmc.org. See Heating and Energy Deposition for more information.)
